    ...
    <div id="main_container" class="container">
        ...
        <table class="table table-striped display" width="100%" id="datatable">
            ...
            <tr>
                ...
                <th><spring:message code="manager.irps_id"/></th>
                <th></th>
                <th></th>
            </tr>
            </thead>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="irpsId" class="control-label col-xs-3"><spring:message code="manager.irps_id"/></label>

                        <div class="col-xs-9">
                            <input type="number" class="form-control" id="irpsId" name="irpsId" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="role" class="control-label col-xs-3"><spring:message code="user.role"/></label>

                        <div class="col-xs-9">
                            <select class="btn btn-default" name="role" id="role"></select>
                        </div>
                    </div>
